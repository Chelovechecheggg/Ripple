...
ripperoni.approx_N_coils(f"Globus3_coils/coils_base.txt", N, 4)
...
for plane_Xminmax in planes_Xminmax:
    for plane_Zminmax in planes_Zminmax:
        ...
        ripperoni.print_ripple(ripple, plane_Xminmax,plane_Zminmax,vol_res,f'Globus3_coils/Ripple_acc_test/Ripple_acc_{l}.txt')
        l+=1
